    ...
    <div className="grid grid-cols-[1fr,2rem] sm:grid-cols-[5rem,1fr,2rem] gap-4 p-4 bg-slate-800 rounded-lg drop-shadow-lg ">
      ...
      <div className="hidden sm:grid content-center">
        <img
          ...
          alt="user"
          className="rounded-full outline outline-sky-500 sm:inline-block"
        />
      </div>
      ...
      <div className="flex flex-col place-content-center">
        ...
        <p className="hidden sm:block text-sm text-slate-300">
          ...
          dolore quo debitis aut in iste fugit quasi ab fugiat.
        </p>
      </div>
      {/* controls */}
      <div className="flex flex-col place-items-end rounded-lg">
        ...
        <BookmarkIcon
          ...
          className="w-8 cursor-pointer hover:text-sky-500 active:scale-95  drop-shadow-xl transition-all"
        />
        <MailIcon
          onClick={handleMail}
          className="w-8 cursor-pointer hover:text-sky-500 active:scale-95  drop-shadow-xl transition-all"
